...
export default async function NewStudentPage() {
  ...
  // The school's own extra fields. The same definitions validate the write,
  // so the form cannot offer a field the server would reject.
  const customFields = (await getActiveDefinitions(ctx.db, ctx.schoolId, 'student')).map((d) => ({
    key: d.key,
    label: d.label,
    labelAm: d.labelAm,
