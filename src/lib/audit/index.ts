...
export const AUDIT_ACTIONS = {
  ...
  'customField.created': 'Defined a custom field',
  'customField.updated': 'Updated a custom field',
  'customField.deactivated': 'Deactivated a custom field',
  ...
  // Reading a pupil's medical record or a staff contract is itself an event a
  // school may need to account for, so downloads are recorded, not just writes.
  'document.download': 'Downloaded a document',
  'document.delete': 'Deleted a document',
  'export.run': 'Exported data',

  // Group 8 - operations
  'staffAttendance.record': 'Recorded staff attendance',
  'staffAttendance.update': 'Changed a staff attendance record',
  ...
  'library.itemCreate': 'Added a library title',
  'library.itemUpdate': 'Updated a library title',
  'library.copyCreate': 'Added a library copy',
  'library.copyUpdate': 'Updated a library copy',
  'library.issue': 'Issued a library loan',
  'library.return': 'Received a library return',
  'library.renew': 'Renewed a library loan',
  'library.fineWaive': 'Waived a library fine',

  'inventory.itemCreate': 'Added a stock item',
  'inventory.itemUpdate': 'Updated a stock item',
  'inventory.movement': 'Recorded a stock movement',

  'asset.create': 'Added an asset',
  'asset.update': 'Updated an asset',
  'maintenance.report': 'Reported a maintenance issue',
  'maintenance.update': 'Updated a maintenance issue',

  'transport.vehicleCreate': 'Added a vehicle',
  'transport.vehicleUpdate': 'Updated a vehicle',
  'transport.routeCreate': 'Created a transport route',
  'transport.routeUpdate': 'Updated a transport route',
  'transport.assign': 'Assigned a student to transport',
  'transport.unassign': 'Removed a student from transport',

  'event.create': 'Created a calendar event',
  'event.update': 'Updated a calendar event',
  'event.delete': 'Deleted a calendar event',
} as const;
