...
export const PERMISSIONS = {
  ...
  'staffAttendance.view': 'View staff attendance records',
  'staffAttendance.take': 'Record staff attendance',
  'leave.request': 'Request leave for oneself',
  'leave.view': 'View leave requests across the school',
  'leave.approve': 'Approve or reject leave requests',
  'leave.configure': 'Configure the kinds of leave the school offers',

  // Library
  'library.view': 'View the library catalogue and loans',
  'library.manage': 'Add and edit library titles and copies',
  'library.issue': 'Issue and receive library loans',

  // Inventory
  'inventory.view': 'View stock levels and movements',
  'inventory.manage': 'Add stock items and record movements',

  // Assets and maintenance
  'asset.view': 'View the asset register',
  'asset.manage': 'Add and edit assets',
  'maintenance.report': 'Report a fault or maintenance need',
  'maintenance.manage': 'Assign, update and close maintenance issues',

  // Transport
  'transport.view': 'View routes, vehicles and student transport',
  'transport.manage': 'Manage routes, vehicles and student transport',

  // School calendar
  'event.view': 'View the school calendar',
  'event.manage': 'Create and edit calendar events',
...
> = {
  ...
  hr_officer: {
    name: 'HR Officer',
    nameAm: 'የሰው ኃይል ኃላፊ',
    description: 'Manages staff records, staff attendance and leave.',
    permissions: [
      'school.view',
      'user.view',
      'user.manage',
  ...
  librarian: {
    name: 'Librarian',
    nameAm: 'ቤተ መጻሕፍት ኃላፊ',
    description: 'Manages the library catalogue and lending.',
    // A librarian needs student.view to identify a borrower, and nothing else
    // about a pupil. No attendance, no marks, no fees.
    permissions: [
      'school.view',
      'student.view',
      'staff.view',
  ...
  storekeeper: {
    name: 'Storekeeper',
    nameAm: 'የመጋዘን ኃላፊ',
    description: 'Manages stock, assets and maintenance. No access to student data.',
    permissions: [
      'school.view',
      'inventory.view',
      'inventory.manage',
  ...
  transport_officer: {
    ...
    nameAm: 'የትራንስፖርት ኃላፊ',
    description: 'Manages vehicles, routes and student transport assignments.',
    permissions: [
      'school.view',
      'student.view',
      'guardian.view',
