...
test('CRITICAL: parents and students hold no permission that reaches school data', () => {
  ...
  const FORBIDDEN = [
    ...
    // Group 8 operations. A parent must not be able to browse the staff
    // leave register, the asset list or another family's transport details,
    // and a pupil must not be able to issue themselves a library book.
